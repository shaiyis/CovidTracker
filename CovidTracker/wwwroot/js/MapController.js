app.controller('MapController', function ($scope,$http) {
    ...
    zingchart.shape_click = function (e) {
        ...
        var currState = zingchart.maps.getItemInfo('usa', shape).tooltip.text;
        currentState = currState;
        numberOfConfirmedCases = 1962;
        var paragraph = document.getElementById("casualties");
        paragraph.style.visibility = "visible";
        $scope.currentState = currentState;
        $scope.numberOfConfirmedCases = 5000;

        // get number of casualties in the state per 100,000 and put in numberOfConfirmedCases
        $http.get('index.html')
